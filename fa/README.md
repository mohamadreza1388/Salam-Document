...
همچنین میتوانید به این گروه‌بندی عنوان هم بدهید که در قسمت بعدی با ان اشنا میشوید
نحوه نوشتن:
```
صفحه:
	گروه‌بندی:
...
به این دستور د قسمت قبلی اشاره کوچکی شد. به وسیله این دستور میتوان برای هر گروه‌بندی یک عنوان تنظیم کرد.
نحوه نوشتن:
```
صفحه:
	گروه‌بندی:
