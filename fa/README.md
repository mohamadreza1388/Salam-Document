...
|`نام قلم` | نام قلم مورد استفاده                        | font-family                 |
|`اندازه قلم` | تعیین اندازه قلم                            | font-size                   |
|`سبک قلم` | تعیین سبک قلم                               | font-style                  |
|`نوع قلم` | نوع واریانت قلم                             | font-variant                |
|`نمایش قلم` | نحوه نمایش قلم                              | font-display                |
|`وزن قلم` | تعیین وزن قلم                               | font-weight                 |
